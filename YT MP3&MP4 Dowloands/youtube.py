...
title = screen.title("Youtube Mp3 İndirici")
...
# Künye Alanı
label14 = Label(screen,text="Ahad Emir KOÇ",font=("Helvetica",13,BOLD),fg="black")
label14.place(x=0, y=620)

label15 = Label(screen,text="Software engineering",font=("Helvetica",13,BOLD),fg="black")
label15.place(x=0, y=650)

label16 = Label(screen,text="ahademirkoc99@hotmail.com",font=("Helvetica",10,BOLD),fg="#780b0b")
label16.place(x=800, y=630)
#------------------------------------------------------------------------------#
